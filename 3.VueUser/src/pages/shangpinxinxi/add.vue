...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    <el-form
      ...
      label-width="150px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="鲜花名称" prop="shangpinmingcheng">
            <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="鲜花名称" clearable :disabled=" false  ||ro.shangpinmingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="店铺名" prop="dianpuming">
            <el-select v-model="ruleForm.dianpuming" placeholder="请选择店铺名" :disabled=" false  ||ro.dianpuming" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="鲜花分类" prop="shangpinfenlei">
            <el-select v-model="ruleForm.shangpinfenlei" placeholder="请选择鲜花分类" :disabled=" false  ||ro.shangpinfenlei" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="积分" prop="jf">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="鲜花介绍" prop="shangpinjieshao">
            <editor 
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/shangjia/dianpuming', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.dianpumingOptions = res.data.data;
          }
        });
