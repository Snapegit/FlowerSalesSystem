...
<div>
	...
	<div class="list-preview" :style='{"padding":"0 12%","margin":"0px auto","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="category-3" :style='{"border":"0px solid #eee","padding":"0 40px","boxShadow":"0px 0px 0px #eee","margin":"0 aut","flexWrap":"wrap","background":"#f3f3f3","display":"flex","width":"100%","height":"auto","order":"1"}'>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px 0","margin":"20px 0 0","borderColor":"#ddd","alignItems":"center","flexWrap":"wrap","background":"none","borderWidth":"0 0 0px","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"2"}'>
      <el-form-item :style='{"margin":"0 5px 0px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 0 0 0px","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>鲜花名称：</div>
        <el-input v-model="formSearch.shangpinmingcheng" placeholder="鲜花名称" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 5px 0px"}'>
	  ...
	  <el-button v-if="btnAuth('shangpinxinxi','新增')" :style='{"cursor":"pointer","border":"0px solid #ddd","padding":"0px 15px","margin":"0px 0px 0 0","color":"#fff","display":"inline-block","outline":"none","borderRadius":"30px","background":"#1c6a6d","width":"90px","fontSize":"14px","lineHeight":"40px","height":"40px"}' type="primary" @click="add('/index/shangpinxinxiAdd')"><i v-if="false" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="sort_view" :style='{"padding":"10px 20px","margin":"26px 0 0","borderColor":"#3493c3","overflow":"hidden","borderRadius":"0px","textAlign":"right","background":"none","borderWidth":"0 0 3px","width":"100%","borderStyle":"solid","order":"3"}'>
		<el-button :style='{"padding":"4px 5px","margin":"0 5px","borderColor":"#28890b","borderRadius":"0px","background":"none","borderWidth":"0 0px 0 0","borderStyle":"solid"}' @click="sortClick('price')">
	...
	<div class="list" :style='{"minHeight":"699px","padding":"20px 0","margin":"20px 0 0","borderRadius":"0px","background":"none","flex":"1","width":"calc(100% - 310px)","float":"left","order":"5"}'>
		...
		<div class="list1 index-pv1" :style='{"padding":"0 0 0 2%","color":"#999","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"auto"}'>
			<div :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0 0 0px","boxShadow":"1px 2px 9px #ccc","margin":"0 2% 30px 0","display":"flex","justifyContent":"flex-end","overflow":"hidden","flexWrap":"wrap","background":"#fff","width":"23%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"0 10px","borderColor":"#ddd","margin":"0 0 6px","whiteSpace":"nowrap","color":"#333","textAlign":"left","overflow":"hidden","borderWidth":"0 0 0px","width":"100%","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dashed"}' class="name ">{{item.shangpinmingcheng}}</div>
				...
				<div :style='{"padding":"0","margin":"0 10px 0 0","display":"inline-block"}'>
				  ...
				  <span class="text" :style='{"color":"inherit","lineHeight":"1.5","fontSize":"inherit"}'>{{item.shangjiazhanghao}}</span>
				</div>
...
<script>
  export default {
    ...
    created() {
		...
		this.$http.get('option/shangpinfenlei/shangpinfenlei').then(res => {
			if (res.data.code == 0) {
				...
				this.selectOptionsList.push({name:'鲜花分类',list:this.shangpinfenleiOptions,tableName: 'shangpinfenlei',check: -1})
			}
		});
      this.getFenlei();
      this.getList(1, '全部');
    ...
    methods: {
      ...
      getFenlei() {
		this.$http.get('shangjia/list',{}).then(res => {
		  if (res.data.code == 0) {
		    this.fenlei = res.data.data.list
		  }
		});
		this.feileiColumn = 'dianpuming'
      },
      getList(page, fenlei, ref = '') {
        ...
        if (this.curFenlei != '全部') searchWhere.dianpuming = this.curFenlei;
